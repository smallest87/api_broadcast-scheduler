...
class UserSettingsController extends BaseController // Extend BaseController
{
    ...
    public function index()
    {
        ...
        if ($num > 0) {
            ...
            http_response_code(200);
            echo json_encode(["message" => "No user settings found.", "data" => []]);
        }
    }
    ...
    public function updateByKey($key)
    {
        ...
        if ($this->userSettings->updateByKey()) {
            http_response_code(200);
            echo json_encode(["message" => "User setting updated."]);
        } else {
            http_response_code(503);
